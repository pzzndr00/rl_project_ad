...
class Agent:
    def __init__(self, env: highway_env, batch_size=256, discount = 0.99, clip_eps = 0.1, step_size = 1e-4, actor_rep = 15, critic_rep = 5):
        ...
        self.critic = Net_critic(input_size = 25)